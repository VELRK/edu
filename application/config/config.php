...
|
*/
// Auto-detect base URL; set APP_BASE_URL env var to override (e.g. production)
if (getenv('APP_BASE_URL')) {
    $config['base_url'] = getenv('APP_BASE_URL');
} elseif (isset($_SERVER['HTTP_HOST'])) {
    $protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
    $config['base_url'] = $protocol . '://' . $_SERVER['HTTP_HOST'] . '/edu/';
} else {
    $config['base_url'] = 'http://localhost:8080/edu/';
}
